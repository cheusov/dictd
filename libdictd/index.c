...
/* Compare:
   ...
   Return
        -2 if word <  word-pointed-to-by-start
...
static int dict_search_prefix_first(
	lst_List l,
	const char *word,
	const dictDatabase *database,
	dictIndex *dbindex,
...
{
	return dict_search_prefix_first(
...
static int dict_search_substring(
	lst_List l,
	const char *word,
	const dictDatabase *database,
	dictIndex *dbindex)
...
static int dict_search_regexpr(
	lst_List l,
	const char *word,
	const dictDatabase *database,
	dictIndex *dbindex,
...
static int dict_search_soundex(
	lst_List l,
	const char *word,
	const dictDatabase *database,
	dictIndex    *dbindex)
